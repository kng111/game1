# import random 
# # parol  = random.randint(0, 10000000000)
# # letters = ['a', 'b', 'c', 'd', 'e', 'f']
# # random_index = random.randrange(len(letters))
# # list1 = [(letters[random_index]),parol]
# parol = 23122003
# print(parol)
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.player_sprite = arcade.Sprite(f":resources:images/enemies/{x2}",
                                           SPRITE_SCALING)
        ...
        for y in range(330, 500, 64):
            wall = arcade.Sprite(":resources:images/tiles/boxCrate_double.png", SPRITE_SCALING)
            wall.center_x = 465
            wall.center_y = y
            self.wall_list.append(wall)

        for y in range(50, 180, 64):
            wall = arcade.Sprite(":resources:images/tiles/boxCrate_double.png", SPRITE_SCALING)
            wall.center_x = 465
            wall.center_y = y
            self.wall_list.append(wall)
    ...
    def on_key_press(self, key, modifiers):
            ...
            with mic as source:
                ...
                if key == 'вверх':
                    ...
                    self.player_sprite.change_x = MOVEMENT_SPEED2
